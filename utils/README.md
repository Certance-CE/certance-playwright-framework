...
is application-specific — all code in this folder must be fully portable
across projects.
...
- No application-specific logic — if it references a specific app's URL, page, or
  UI element, it belongs in `pages/` not here

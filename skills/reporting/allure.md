# Certance — Allure Reporting Guide

**Applies to:** All Certance client engagements
**Reporter:** Allure with allure-playwright integration
**Purpose:** Client-facing coverage visibility and stakeholder reporting

Allure is the primary reporting layer. The built-in Playwright HTML report
is for local debugging only. Allure is what goes to the client.
...
## Gap report template (for client stakeholders)
...
```
Certance Coverage Report — [Client] — [Date]
...
3. Reporting — No automated coverage
   ...
   Severity: HIGH — compliance-relevant for [Client]

...
export default tseslint.config(
  ...
  // Framework self-tests deliberately do odd things (throw-in-disposer, test.fail()).
  {
    files: ['tests/cleanup.spec.ts', 'tests/contract.spec.ts', 'tests/foundation.spec.ts'],
